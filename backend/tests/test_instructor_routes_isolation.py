...
ROUTES = [
    ...
    ("GET",    "/instructor/essays/{id}/versions",      "read1",  EA, None, None),
    ("POST",   "/instructor/essays/{id}/compose",       "action", EA,
        {"base_version": 1, "mainCriterion": 1, "coherenceCohesion": 1,
         "lexicalResource": 1, "grammaticalRange": 1}, None),
