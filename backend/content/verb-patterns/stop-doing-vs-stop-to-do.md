...
| Cấu trúc | Nghĩa | Hành động sau "stop" |
|----------|-------|-------------------|
| **stop + doing** (gerund) | Dừng hẳn, không làm nữa | Bị chấm dứt |
| **stop + to do** (infinitive) | Dừng lại để làm việc khác | Bắt đầu được thực hiện |
