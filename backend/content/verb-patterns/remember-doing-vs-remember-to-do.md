...
| Cấu trúc | Nghĩa | Thời điểm hành động |
|----------|-------|-------------------|
| **remember + doing** (gerund) | Nhớ lại rằng mình đã làm việc gì đó | Hành động đã xảy ra **trước** khi nhớ |
| **remember + to do** (infinitive) | Nhớ (không quên) phải làm gì đó | Hành động xảy ra **sau** khi nhớ |
