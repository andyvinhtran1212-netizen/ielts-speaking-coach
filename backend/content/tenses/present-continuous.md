...
Trong IELTS Speaking, Present Continuous xuất hiện nhiều trong:
- **Part 1:** Mô tả những gì bạn đang làm gần đây / hiện tại
- **Part 2:** Nếu đề bài hỏi về điều bạn đang trải qua
- **Part 3:** Nói về xu hướng xã hội đang thay đổi: "More and more people **are working** from home..."
...
1. Hành động đang xảy ra **ngay lúc nói** (right now)
...
- I **'m living** with my parents this month while I look for an apartment.
  *(Tôi đang sống với bố mẹ tháng này — tạm thời, không phải thường xuyên)*
- She **'s studying** at RMIT this semester.
- He **'s working** extra hours because of a big project.

**Khác với Present Simple:**
- "I **live** with my parents." → Tôi sống với bố mẹ (thường xuyên, tình trạng cố định)
- "I **'m living** with my parents." → Tôi đang sống với bố mẹ (tạm thời thôi)
...
### Điền vào chỗ trống
1. Look! The sun _____ (shine) through the clouds.
2. She _____ (not study) right now — she's on her phone.
3. These days, more people _____ (work) from home.
4. _____ you _____ (enjoy) the Grammar Wiki so far?
5. My sister _____ (apply) for a scholarship this semester.

### Viết lại câu dùng Present Continuous
1. She is a temporary resident. (live / with her aunt / this month)
2. The world changes quickly. (technology / reshape / the way we communicate)
3. My teacher gets annoyed. (I / always arrive / late)
...
**Viết lại:**
1. She is living with her aunt this month.
2. Technology is reshaping the way we communicate.
3. I'm always arriving late (— my teacher gets annoyed).
