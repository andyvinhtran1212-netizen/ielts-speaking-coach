...
anchors:
  ...
  - id: future-forms.will.spontaneous-decision
    location: "### 1. will — Quyết định bộc phát (Spontaneous Decisions)"
    type: section
  - id: future-forms.will.prediction
    location: "### 2. will — Dự đoán (Predictions)"
    type: section
  - id: future-forms.be-going-to.intention
    location: "### 4. be going to — Kế hoạch / Dự định đã có sẵn (Plans & Intentions)"
    type: section
  - id: future-forms.be-going-to.evidence-prediction
    location: "### 5. be going to — Dự đoán có bằng chứng (Predictions with Evidence)"
    type: section
  - id: future-forms.present-continuous.arrangement
    location: "### 6. Present Continuous — Lịch trình / Hẹn hò đã xác nhận (Arrangements)"
    type: section
...
- **Part 1:** "What are your plans for the weekend?" → Cần *be going to* hoặc Present Continuous, không phải *will*
- **Part 2:** Nói về kế hoạch tương lai → phân biệt giữa dự định và lịch trình
- **Part 3:** Dự đoán xu hướng → *will* là lựa chọn tự nhiên
...
<!-- anchor: future-forms.will.spontaneous-decision -->
...
<!-- anchor: future-forms.will.prediction -->
...
<!-- anchor: future-forms.be-going-to.intention -->
...
<!-- anchor: future-forms.be-going-to.evidence-prediction -->
...
<!-- anchor: future-forms.present-continuous.arrangement -->
...
**Tình huống:** Bạn của bạn vừa nói sẽ dọn nhà và bạn quyết định đến giúp:
- ❌ SAI: "I**'m going to help** you." *(Ngụ ý bạn đã có kế hoạch này từ trước)*
- ✅ ĐÚNG: "I**'ll help** you." *(Quyết định ngay lúc nghe — will)*

**Tình huống:** Bạn đã có kế hoạch từ tuần trước:
- ❌ SAI: "I**'ll go** to the gym tomorrow." *(Ngụ ý vừa quyết định bây giờ)*
- ✅ ĐÚNG: "I**'m going to go** to the gym tomorrow." *(Đã có kế hoạch)*
...
<!-- anchor: future-forms.compare-with.three-forms -->
...
**will & be going to:** Đôi khi hoán đổi được trong câu dự đoán (will là tự nhiên hơn cho dự đoán không có bằng chứng trực tiếp):
- "I think it **will rain** later." *(will — dự đoán chung)*
- "Look at those clouds — it**'s going to rain**." *(going to — có bằng chứng)*

**be going to & Present Continuous:** Đôi khi hoán đổi được cho kế hoạch đã xác nhận:
- "I**'m going to see** him tomorrow." *(dự định)*
- "I**'m seeing** him tomorrow at noon." *(lịch trình cụ thể — tự nhiên hơn với thời gian cụ thể)*
...
1. **Vừa quyết định ngay lúc nói?** → **will**
   - "A: There's no sugar." B: "I'**ll get** some." *(Vừa nghĩ ra)*

2. **Đã có kế hoạch/dự định từ trước?** → **be going to**
...
**Nói về kế hoạch cá nhân (Part 1 & 2):**
- "I**'m planning to** / I**'m going to** take a gap year after graduation."
- "I**'ve been thinking about** changing careers, and I**'m going to** start taking evening classes."
- "As for this weekend, I**'m visiting** my family — we**'re celebrating** my mother's birthday."

**Đưa ra dự đoán (Part 3):**
- "I think remote work **will become** increasingly common over the next decade."
- "It**'s likely that** technology **will replace** many routine jobs."
- "I believe attitudes **will gradually shift** as the next generation grows up."
- "Whether or not this **will happen** depends largely on government policy."

**Nói về quyết định bộc phát (tự nhiên trong hội thoại):**
- "Actually, that**'s** a great point — I**'ll think** about that more carefully."
...
1. A: We've run out of coffee. B: That's fine — I _____ (go) and buy some. *(Quyết định bộc phát)*
2. I _____ (study) medicine — I've already applied to three universities.
3. Look at that car! It _____ (crash) into the wall!
4. I _____ (meet) Anna at the airport tomorrow at 6am. *(Đã hẹn và xác nhận)*
5. I think the economy _____ (improve) next year.
6. A: The phone's ringing! B: I _____ (get) it.
7. What _____ you _____ (do) next summer? *(Hỏi về kế hoạch đã có)*

### Sửa lỗi

1. I will fly to Hanoi next Tuesday morning. *(Vé đã đặt)*
2. When I will arrive, I'll call you.
3. She's go to start a new job next month.
4. I'm going study law at university.
5. I will probably go to the gym tomorrow. *(Đã có kế hoạch)*

### Dùng đúng dạng để trả lời

1. "What are your plans for after you finish studying?"
2. "Will the weather be good this weekend?" *(Nhìn thấy bầu trời xanh)*
3. "Can anyone help me move this table?" *(Quyết định ngay)*

### Đáp án

**Chọn đúng dạng:**
1. **I'll go** (quyết định bộc phát)
2. **I'm going to study** (kế hoạch đã có)
3. **It's going to crash** (bằng chứng trực tiếp)
4. **I'm meeting** (lịch trình đã xác nhận)
5. **will improve** (dự đoán chung)
6. **I'll get** (quyết định bộc phát)
7. **are you going to do** (hỏi kế hoạch đã có)

**Sửa lỗi:**
1. "I**'m flying** to Hanoi next Tuesday morning." (lịch trình đã xác nhận)
2. "When I **arrive**, I'll call you." (mệnh đề "when" → Present Simple)
...
2. **be going to** = kế hoạch đã có trước + dự đoán có bằng chứng trực tiếp
3. **Present Continuous** = lịch trình đã xác nhận với người khác (thường có thời gian cụ thể)
