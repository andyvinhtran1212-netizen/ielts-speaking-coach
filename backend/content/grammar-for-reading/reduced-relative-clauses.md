...
- grammar-for-reading
anchors:
- id: reduced-relative-clauses.overview
  location: '## Tóm tắt'
  type: overview
- id: reduced-relative-clauses.active-ing
  location: '### Rút gọn chủ động → V-ing'
  type: section
- id: reduced-relative-clauses.passive-v3
  location: '### Rút gọn bị động → V3 (past participle)'
  type: section
...
<!-- anchor: reduced-relative-clauses.pitfall -->
## Bẫy khi đọc
