...
slug: a-short-history-of-tea
difficulty_level: foundation
topic_tags: [culture, food-and-drink]
estimated_minutes: 4
word_count: 150
published: true
glossary:
  - term: beverage
    definition: một loại đồ uống, đặc biệt là loại không phải nước lọc
    example: Tea is the most popular beverage in the world after water.
  - term: ritual
    definition: một chuỗi hành động được thực hiện theo cách cố định, thường mang ý nghĩa
    example: In Japan, making tea can be a careful ritual.
questions:
  - q_num: 1
    question_type: true_false_not_given
    prompt: Tea is the most consumed drink in the world.
    answer: "FALSE"
...
boiling water. Today it is the most popular **beverage** on Earth after plain
water.

From China, tea travelled along trade routes to Japan, India, and eventually
Europe. Each culture made it its own. In Japan, preparing and serving tea grew
into a careful **ritual**, with precise steps and quiet attention. In Britain,
it became a daily habit shared with milk and conversation.

Wherever it went, tea did more than quench thirst — it brought people together.
