...
|----------|-------|-------|
| **need + V-ing** | The car needs **washing**. | Xe cần được rửa. |
| **need + to be + V3** | The car needs **to be washed**. | Xe cần được rửa. |
| **(Chủ ngữ người) need + to do** | I need **to wash** the car. | Tôi cần rửa xe. |

Hai cấu trúc đầu có nghĩa **gần như giống nhau** — điểm khác biệt chủ yếu là phong cách và độ tự nhiên.
