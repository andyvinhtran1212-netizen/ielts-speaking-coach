...
| Cấu trúc | Nghĩa | Kết quả |
|----------|-------|---------|
| **try + doing** (gerund) | Thử một cách/giải pháp xem có hiệu quả không | Có thể thành công hoặc không — đang thử nghiệm |
| **try + to do** (infinitive) | Cố gắng làm điều gì đó, thường gặp khó khăn | Khó, có thể không thành công |
