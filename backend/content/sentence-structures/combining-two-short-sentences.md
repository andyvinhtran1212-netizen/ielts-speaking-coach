...
| Cách | Công cụ | Ví dụ |
|------|---------|-------|
| **Liên từ kết hợp** | and, but, so, or (FANBOYS) | It rained, **so** we stayed in. |
| **Liên từ phụ thuộc** | because, although, when, while, since | We stayed in **because** it rained. |
| **Mệnh đề quan hệ** | who, which, that, where | Hanoi, **which** is the capital, is busy. |
| **Cụm phân từ** | V-ing / V-ed mở đầu | **Feeling tired,** she left early. |
| **Đồng vị ngữ** | danh từ giải thích | Hanoi, **the capital,** is busy. |
...
5. Ha Long Bay is stunning. It is a UNESCO site. *(đồng vị ngữ)*
...
| Quan hệ giữa 2 câu | Dùng | Ví dụ |
|--------------------|------|-------|
| Ngang hàng | and / but / so / or (+ phẩy) | ..., so ... |
| Nguyên nhân–kết quả / nhượng bộ | because / although / when | Because..., ... |
| Cùng một danh từ | who / which / that | ..., which ... |
| Cùng chủ ngữ, 2 hành động | V-ing / V-ed phrase | Feeling tired, ... |
| Giải thích danh từ | đồng vị ngữ (, ... ,) | X, the capital, ... |
