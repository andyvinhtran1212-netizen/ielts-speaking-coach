...
2. I only need **a few** minutes to explain. (minutes = countable → a few)
3. **Little** progress has been made... (progress = uncountable → little)
4. We received **a little** useful information... (information = uncountable → a little)
5. There were **few** people at the party. (people = countable → few)
