...
anchors:
  - id: articles-a-an-sound-rules.overview
    location: '## Tóm tắt'
    type: overview
  - id: articles-a-an-sound-rules.core.sound-not-letter
    location: '## QUY TẮC CỐT LÕI: ÂM ĐẦU, KHÔNG PHẢI CHỮ CÁI ĐẦU'
    type: concept
  - id: articles-a-an-sound-rules.h-silent-vs-pronounced
    location: '## PHẦN 2: CHỮ "H" — Câm hay không câm?'
    type: pitfall
  - id: articles-a-an-sound-rules.initialisms-and-letters
    location: '## PHẦN 4: TỪ VIẾT TẮT VÀ CHỮ CÁI ĐƠN'
    type: section
---

<!-- anchor: articles-a-an-sound-rules.overview -->
## Tóm tắt
...
<!-- anchor: articles-a-an-sound-rules.h-silent-vs-pronounced -->
...
<!-- anchor: articles-a-an-sound-rules.initialisms-and-letters -->
...
1. She is ___ honest and dedicated employee.
2. He took ___ one-hour break after lunch.
3. This is ___ unique solution to ___ old problem.
4. She completed ___ MBA and then worked for ___ NGO.
...
1. an | 2. a | 3. a / an | 4. an / an | 5. an / a | 6. an / a | 7. a / an / an | 8. a / a
