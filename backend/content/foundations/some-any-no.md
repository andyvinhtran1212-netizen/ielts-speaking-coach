...
So sánh:
- "Do you have **any** milk?" *(hỏi thật — không biết có không)*
- "Would you like **some** milk?" *(mời — giả định có)*
...
- **No** students passed the test. *(không một học sinh nào)*
...
|-----------------|----------------|--------------|
| **Some**one called you. | Did **any**one call? | **No one** called. |
| I met **some**body interesting. | Is **any**body here? | **No**body was home. |

> **Viết đúng:**
> - *someone* → **một từ**
> - *anyone* → **một từ**
> - *no one* → **hai từ** (khác với nobody — một từ)
> - *nobody* → **một từ**
...
> **Ngoại lệ với "something" trong câu hỏi:**
> - "Would you like **something** to drink?" *(mời mọc)*
> - "Can I get you **something**?" *(kỳ vọng "yes")*
