...
anchors:
  - id: parts-of-speech.tom-tat
    location: '## Tóm tắt'
    type: overview
  - id: parts-of-speech.tai-sao-quan-trong
    location: '## Tại sao quan trọng'
    type: section
  - id: parts-of-speech.loi-thuong-gap
    location: '## Lỗi thường gặp'
    type: pitfall
  - id: parts-of-speech.bai-tap-luyen
    location: '## Bài tập luyện'
    type: section
---

<!-- anchor: parts-of-speech.tom-tat -->
## Tóm tắt
...
<!-- anchor: parts-of-speech.tai-sao-quan-trong -->
## Tại sao quan trọng

Người học Việt Nam thường học thuộc từ vựng mà không biết **từ đó là danh từ hay động từ**. Hậu quả là:
- Đặt sai vị trí từ trong câu: "I very like coffee" thay vì "I really like coffee"
- Dùng sai dạng từ: "She is beauty" thay vì "She is beautiful"
- Không biết chia thì vì không xác định được động từ chính
...
**Đuôi hay gặp:** -tion, -ment, -ness, -ity, -ance, -er/-or
- educate → educa**tion**
...
- quick → quick**ly**
- careful → careful**ly**
- **Ngoại lệ:** fast, hard, well (không thêm -ly)
...
<!-- anchor: parts-of-speech.loi-thuong-gap -->
## Lỗi thường gặp
...
### Sửa lỗi
1. The teacher explained the lesson very clear.
2. She is a beauty woman with long hair.
3. I feel happily when I travel.
4. His speak English is very good.
5. She works hardly every day.
...
**Sửa lỗi:**
1. clearly (adverb bổ nghĩa cho "explained")
2. beautiful (adjective trước noun)
3. happy (adjective sau "feel" — linking verb)
4. His English speaking / His spoken English (dùng danh từ)
5. hard (không thêm -ly; "hardly" = hầu như không, nghĩa khác)

## Tóm tắt nhanh
1. 8 từ loại: Noun, Verb, Adjective, Adverb, Pronoun, Preposition, Conjunction, Interjection
