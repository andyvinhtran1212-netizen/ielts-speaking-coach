...
| `pages/admin/listening/index.html` · `pages/admin/listening/upload.html` · `pages/admin/listening/convert.html` · `pages/admin/listening/import-fulltest.html` · `pages/admin/listening/import-drills.html` · `pages/admin/listening/audit.html` · `pages/admin/listening/audit-detail.html` · `pages/admin/listening/segments.html` · `pages/admin/listening/audio-cutter.html` · `pages/admin/listening/render.html` · `pages/admin/listening/content-detail.html` · `pages/admin/listening/content-meta.html` · `pages/admin/listening/gist.html` · `pages/admin/listening/tf.html` · `pages/admin/listening/mcq.html` · `pages/admin/listening/tests.html` · `pages/admin/listening/tests-detail.html` · `pages/admin/listening/dictation-reports.html` | admin | Listening authoring (`/admin/listening/*`): import/convert DOCX, **4-file full-test pack import** (`import-fulltest.html`, #408), cut/segment + AI-render audio, build per-type exercises + Cambridge tests. Deep ref: [`listening-architecture.md`](listening-architecture.md). |
