...
|---|---|---|
| `/admin/speaking` (`pages/admin/speaking/index.html` rollback) · `pages/admin/speaking/topics.html` · `pages/admin/speaking/sessions.html` | admin | Native Speaking operations hub; manage topics and browse/regrade graded sessions in the legacy child workspaces while they await separate migrations (`/admin/*`). |
