...
| `/admin/grammar` (`pages/admin/grammar/index.html` rollback) · `pages/admin/grammar/articles.html` · `pages/admin/grammar/analytics.html` · `pages/admin/grammar/recommend-test.html` | admin | Native Grammar content-operations hub + file-based article browser, recommendation analytics/testing and shared Grammar exercise console. Articles remain repository-authored Markdown; the hub exposes no edit mutation. |
