...
| `/admin/listening` (native content inventory) · `/admin/listening/content/[contentId]` (native content detail/status) · `/admin/listening/tests` (native test inventory/status/exam scope) · `/admin/listening/tests/[testId]` (native audio/map/publication workspace) · corresponding `pages/admin/listening/*.html` rollback pages · `pages/admin/listening/import-fulltest.html` · `pages/admin/listening/import-drills.html` · `pages/admin/listening/audit.html` · `pages/admin/listening/audit-detail.html` · `pages/admin/listening/segments.html` · `pages/admin/listening/content-meta.html` · `pages/admin/listening/gist.html` · `pages/admin/listening/tf.html` · `pages/admin/listening/mcq.html` · `pages/admin/listening/tests-detail.html` · `pages/admin/listening/dictation-reports.html` | admin | Listening authoring (`/admin/listening/*`): native inventories plus canonical content/test detail workspaces own clean routes. Test detail reconciles mode, audio, assemble, maps, lifecycle and destructive actions with backend truth; metadata/exercise editors and import/audit flows remain legacy workspaces until migrated. Includes **4-file full-test pack import** (`import-fulltest.html`, #408) + skill-drill import, build per-type exercises + Cambridge tests. (ElevenLabs assembly remains active inside test detail; standalone audio cutter / convert DOCX were decommissioned 2026-07-17 — usage audit.) Deep ref: [`listening-architecture.md`](listening-architecture.md). |
