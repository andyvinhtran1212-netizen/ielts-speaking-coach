...
| `/admin/grammar` (`pages/admin/grammar/index.html` rollback) · `/admin/grammar/articles` (`pages/admin/grammar/articles.html` rollback) · `pages/admin/grammar/analytics.html` · `pages/admin/grammar/recommend-test.html` | admin | Native Grammar content-operations hub + native file-based article inventory, recommendation analytics/testing and shared Grammar exercise console. Articles remain repository-authored Markdown; the hub and inventory expose no edit mutation. |
