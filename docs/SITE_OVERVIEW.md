...
| `pages/admin/listening/index.html` · `pages/admin/listening/convert.html` · `pages/admin/listening/import-fulltest.html` · `pages/admin/listening/import-drills.html` · `pages/admin/listening/audit.html` · `pages/admin/listening/audit-detail.html` · `pages/admin/listening/segments.html` · `pages/admin/listening/content-detail.html` · `pages/admin/listening/content-meta.html` · `pages/admin/listening/gist.html` · `pages/admin/listening/tf.html` · `pages/admin/listening/mcq.html` · `pages/admin/listening/tests.html` · `pages/admin/listening/tests-detail.html` · `pages/admin/listening/dictation-reports.html` | admin | Listening authoring (`/admin/listening/*`): import/convert DOCX, **4-file full-test pack import** (`import-fulltest.html`, #408), build per-type exercises + Cambridge tests. (MP3 upload / ElevenLabs render / audio cutter decommissioned 2026-07-17 — usage audit.) Deep ref: [`listening-architecture.md`](listening-architecture.md). |
