...
| `pages/admin/listening/index.html` · `pages/admin/listening/import-fulltest.html` · `pages/admin/listening/import-drills.html` · `pages/admin/listening/audit.html` · `pages/admin/listening/audit-detail.html` · `pages/admin/listening/segments.html` · `pages/admin/listening/content-detail.html` · `pages/admin/listening/content-meta.html` · `pages/admin/listening/gist.html` · `pages/admin/listening/tf.html` · `pages/admin/listening/mcq.html` · `pages/admin/listening/tests.html` · `pages/admin/listening/tests-detail.html` · `pages/admin/listening/dictation-reports.html` | admin | Listening authoring (`/admin/listening/*`): **4-file full-test pack import** (`import-fulltest.html`, #408) + skill-drill import, build per-type exercises + Cambridge tests. (MP3 upload / ElevenLabs render / audio cutter / convert DOCX decommissioned 2026-07-17 — usage audit.) Deep ref: [`listening-architecture.md`](listening-architecture.md). |
...
| `/admin/grammar` (`pages/admin/grammar/index.html` rollback) · `/admin/grammar/articles` (`pages/admin/grammar/articles.html` rollback) · `/admin/grammar/analytics` (`pages/admin/grammar/analytics.html` rollback) · `pages/admin/grammar/recommend-test.html` | admin | Native Grammar content-operations hub, file-based article inventory and truthful analytics snapshot; recommendation testing and the shared Grammar exercise console remain legacy-owned. Articles remain repository-authored Markdown; these native surfaces expose no edit mutation. |
