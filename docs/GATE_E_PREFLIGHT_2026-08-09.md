...
trở về Legacy trong forward-rollback candidate, còn rollback artifact chưa hoàn tất.
...
phần rollback của Reading, toàn bộ active-session drill của Listening và
