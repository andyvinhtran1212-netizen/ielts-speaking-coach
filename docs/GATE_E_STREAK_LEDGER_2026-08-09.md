...
Manifest v18 giữ nguyên denominator 34 test live-staging và contract chạy
...
So với v17, shared staging helper tách header bypass trực tiếp khỏi header mint
cookie: probe `maxRedirects: 0` nay quan sát redirect của ứng dụng, không nhầm
