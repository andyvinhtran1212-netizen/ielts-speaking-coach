---
kind: quiz
code: "G-grammar-for-reading-participle-clauses"
title: "Quick Check — Participle Clauses"
skill_area: "grammar"
...
skill: "error_id"
subtype: "advanced"
prompt: "Đúng hay Sai: 'Developing sustainable technologies, the corporation reduced its carbon footprint significantly.'"
answer: true
grammar_article_slug: "participle-clauses"
explain: "ĐÚNG — 'Developing' là V-ing, mệnh đề phân từ chủ động. Chủ ngữ ẩn = chủ ngữ của câu chính 'corporation'. Thay cho 'Because the corporation developed...'"
---

# ===== item_key 2 · V3 (bị động) =====
...
skill: "error_id"
subtype: "advanced"
prompt: "Đúng hay Sai: 'Trained extensively by experts, the athletes performed at their highest level during the competition.'"
answer: true
grammar_article_slug: "participle-clauses"
explain: "ĐÚNG — 'Trained' là V3, mệnh đề phân từ bị động. Chủ ngữ ẩn = 'athletes'. Thay cho 'Because they were trained...'"
---

# ===== item_key 3 · Having + V3 (xảy ra trước) =====
...
skill: "error_id"
subtype: "advanced"
prompt: "Đúng hay Sai: 'Having reviewed the medical records thoroughly, the diagnosis became much clearer to the doctors.'"
answer: false
grammar_article_slug: "participle-clauses"
explain: "SAI — 'diagnosis' không thể 'review' → đây là câu treo (dangling). Nên là: 'Having reviewed the medical records thoroughly, the doctors understood the diagnosis better.'"
---

# ===== item_key 4 · Ý ẩn của phân từ (thời gian/nguyên nhân/kết quả) =====
...
skill: "usage"
subtype: "basic"
prompt: "What does the participle clause express? 'Arriving home, she found the apartment empty.'"
...
skill: "contrast"
subtype: "intermediate"
prompt: "The volcano erupted, forcing thousands to flee. What does the participle express?"
options: ["time (when)", "cause (why)", "result (consequence)", "condition (if)"]
answer: 2
grammar_article_slug: "participle-clauses"
explain: "Cụm 'forcing thousands to flee' **cuối câu** với dấu phẩy chỉ **kết quả/hệ quả** của hành động chính (núi lửa phun → khiến hàng nghìn người phải chạy)."
---
