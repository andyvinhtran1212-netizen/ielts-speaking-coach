---
kind: quiz
code: "G-grammar-for-reading-reduced-relative-clauses"
title: "Quick Check — Reduced Relative Clauses"
skill_area: "grammar"
...
skill: "error_id"
subtype: "advanced"
prompt: "Đúng hay Sai: 'The students solving the problem in the exam displayed excellent analytical skills.'"
answer: true
grammar_article_slug: "reduced-relative-clauses"
explain: "ĐÚNG — V-ing 'solving' bổ nghĩa cho 'students' (những sinh viên đang giải quyết vấn đề). 'displayed' là động từ chính của câu."
---

# ===== item_key 2 · Rút gọn bị động → V3 =====
...
skill: "form"
subtype: "basic"
prompt: "Identify the main verb in this sentence: 'The theory proposed in 1905 changed physics.'"
options: ["proposed", "changed", "in", "1905"]
answer: 1
grammar_article_slug: "reduced-relative-clauses"
explain: "Động từ chính của câu là 'changed'. 'Proposed' là V3 bổ nghĩa cho 'theory' (mệnh đề rút gọn), KHÔNG phải động từ chính."
---
...
skill: "usage"
subtype: "intermediate"
prompt: "The regulations established by the government ____ businesses across multiple sectors."
options: ["affects", "affect", "affecting", "which affect"]
answer: 1
grammar_article_slug: "reduced-relative-clauses"
explain: "Chủ ngữ là 'regulations' (số nhiều) → động từ chính là 'affect' (số nhiều). 'Established' là V3 bổ nghĩa cho 'regulations', KHÔNG phải động từ chính."
---
