...
>
> **AMENDMENT A1 (2026-08-03) — cổng parity thay cửa sổ thời gian.** Với route low/zero-traffic, **"48–72h quan sát" KHÔNG còn là điều kiện PASS**. Thay bằng: **G1** cổng parity legacy↔Next trên toàn bộ URL inventory (trước cutover, chặn merge) · **G2** probe synthetic chủ động trải theo thời gian, **bao gồm route cần đăng nhập** · **G3** ngưỡng lỗi tuyệt đối 0. Cơ sở: cửa sổ `/profile` nhận đúng **2 request trong 25,1h** (0 organic, 0 synthetic vì production-smoke chạy ẩn danh) nên lỗi thời-gian-trôi không thể hiện ra; trong khi cổng parity tìm ra **2 lỗi production thật** trên đúng những route ĐÃ qua cửa sổ (#907, #908). **Không thay được:** đa dạng client — ghi nhận là năng lực bị bỏ, không phải được thay. Chi tiết + ma trận sàn A1: `docs/adr/ADR-013-early-stage-rollout.md` mục "Sửa đổi A1".
