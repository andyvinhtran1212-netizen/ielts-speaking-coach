...
| 20 nightly sạch liên tiếp (frozen matrix) | ⏳ **2/20** | staging-e2e nightly 19 test/đêm từ 2026-07-13; đủ 20 ≈ 2026-08-02 (được phép chạy `workflow_dispatch` bù, mỗi run tính 1) |
...
| Gap | Chặn | Kế hoạch |
|---|---|---|
| 20 nightly sạch (2/20) | MỌI cutover | Tích lũy tự nhiên (~2026-08-02) hoặc dispatch bù; retry reset streak |
