...
export const STUDENT_CODES = [
    ...
    "STUDENT04", 
    "STUDENT05",
    "Hoaiphuongtt21@gmail.com",
    "lnbngoc91@gmail.com",
    "letheenthanh3395@gmail.com",
    "baotran07052006@gmail.com",
    "ntnp200@gmail.com",
    "linh.ntp155@gmail.com",
    "tu.ngo2805@gmail.com",
    "quocan2201@gmail.com",
    "tuongvi2296@gmail.com",
    "lananhbuile@gmail.com",
    "minhthongdinh318@gmail.com",
    "andyvinhtran1212@gmail.com"
];

export const IELTS_CRITERIA_DESCRIPTIONS = {
  fluency: "The ability to speak smoothly and coherently, without excessive hesitation or self-correction.",
  lexicalResource: "The range of vocabulary used and the ability to use it accurately and appropriately.",
  grammar: "The range and accuracy of grammatical structures used.",
  pronunciation: "The ability to produce comprehensible speech with appropriate pronunciation features.",
};
...
export const P2_PREP_INSTRUCTION = "Alright, now I'm going to give you a topic and I'd like you to talk about it for one to two minutes. Before you talk, you'll have one minute to think about what you are going to say. You can make some notes if you wish. Here is your topic.";
export const P2_SPEAKING_INSTRUCTION = "Alright, remember you have one to two minutes for this, so don't worry if I stop you. I'll tell you when the time is up. Can you start speaking now, please?";
export const P2_PRACTICE_PREP_START = "Your one minute preparation time starts now.";
export const P2_PRACTICE_PREP_END = "Preparation time is over. Please start speaking now.";