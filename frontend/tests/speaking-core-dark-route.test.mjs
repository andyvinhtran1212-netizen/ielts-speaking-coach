/** Gate E Speaking: forward rollback descendant keeps the verified Next session stable. */
...
describe('/practice/session staging forward-rollback route', () => {
  ...
  test('the verified Next route stays available while staging admission returns to Legacy', () => {
