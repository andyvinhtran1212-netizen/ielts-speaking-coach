...
| Phase 4 | 6.13 – 6.15 | **In progress (2/3 marketing complete).** Sprint 6.13a: `index.html` ✅ (also deletes Era B `landing.html` orphan). Sprint 6.13b: `pricing.html` ✅ (Era B legacy retired). Sprint 6.14: `dashboard.html` + `admin.html` cluster. Sprint 6.15: Grammar Wiki cluster. |
