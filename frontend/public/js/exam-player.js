...
(function () {
  ...
  var SOURCE_LABEL = { toeic_rc: 'TOEIC · Reading', toeic_lc: 'TOEIC · Listening', thpt_qg: 'THPT Quốc gia', grammar_reading: 'Ngữ pháp Đọc hiểu', grammar_practice: 'Luyện Ngữ pháp', vocab_context: 'Từ vựng theo ngữ cảnh' };
