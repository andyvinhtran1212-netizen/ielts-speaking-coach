...
(function () {
  ...
  var api = {
    ...
    /** @template T @param {string} path @param {FormData} fd @param {*} [opts] @param {Record<string,string>} [hdrs] @returns {Promise<T>} */
    uploadWith: function (path, fd, opts, hdrs) { return _apiRequest('POST', path, fd, true, hdrs, opts); },
