...
export function validateListeningPhaseLineage({ phase, sourceSha, floorSha, isAncestor }) {
...
function run() {
  ...
  const output = path.resolve('test-results/gate-e-listening-coexistence-lineage.json');
  let evidence;
  try {
