...
check('hub có đủ mười workspace và canonical links', await page.locator('a.avv-card').count() === 10
  ...
  && await page.locator('a.avv-card[href="/admin/vocab/pilot-metrics"]').count() === 1
