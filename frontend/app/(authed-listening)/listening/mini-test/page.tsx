...
export default function ListeningMiniTestPage() {
  return (
    <>
      ...
      <link rel="modulepreload" href="/js/listening-mini-test.js" />
      <LegacyModule src="/js/listening-mini-test.js" />
      ...
      <script dangerouslySetInnerHTML={{ __html: watchdogScript('/pages/listening-mini-test.html') }} />
    </>
  );
}
