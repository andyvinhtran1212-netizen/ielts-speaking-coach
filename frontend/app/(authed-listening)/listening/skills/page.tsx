// Trang Skills Practice trên Next — `/listening/skills`.
//
// Nhóm trang CHỈ-ĐỌC: KHÔNG có tầng hành vi. Logic nằm trong ES module legacy
// `/js/listening-skills.js` và bản Next nạp ĐÚNG tệp đó — không chép dòng nào, nên hai vế không
...
//
// `/pages/listening-skills.html` vẫn trả 200 và đó là CỐ Ý: cổng parity chỉ so được khi
// cả hai vế còn sống.
...
export default function ListeningSkillsPage() {
  return (
    <>
      ...
      <link rel="modulepreload" href="/js/listening-skills.js" />
      <LegacyModule src="/js/listening-skills.js" />
      ...
      <script dangerouslySetInnerHTML={{ __html: watchdogScript('/pages/listening-skills.html') }} />
    </>
  );
}
