// Route-group của trang Flashcards (`/flashcards`).
//
...
export default function AuthedFlashcardsLayout({ children }: { children: ReactNode }) {
  return (
    <AuthedShell pageStylesheets={['/css/flashcards.css']}>
      {children}
    </AuthedShell>
  );
}
