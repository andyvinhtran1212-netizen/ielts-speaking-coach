...
// legacy `/js/reading-test.js` và bản Next nạp ĐÚNG tệp đó — không chép một dòng nào, nên
// không có cơ hội hai vế lệch nhau, và sửa một chỗ là cả hai cùng đổi.
//
// `/pages/reading-test.html` vẫn trả 200 và đó là CỐ Ý: cổng parity chỉ so được khi
...
export default function ReadingTestPage() {
  return (
    <>
      ...
      <link rel="modulepreload" href="/js/reading-test.js" />
      <LegacyModule src="/js/reading-test.js" />
      ...
      <script dangerouslySetInnerHTML={{ __html: watchdogScript('/pages/reading-test.html') }} />
    </>
  );
}
