  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div id="state-mode-choice" className="state block-state flex-1 av-w-read py-12 ds-fadein practice-stage practice-stage--choice">
        ...
        <div id="state-prep" className="state block-state flex-1 av-w-read py-8 ds-fadein practice-stage practice-stage--player">
        ...
        <div id="state-p2a" className="state block-state flex-1 av-w-read py-6 practice-stage practice-stage--part2">
        ...
        <div id="state-p2b" className="state block-state flex-1 av-w-read py-6 practice-stage practice-stage--part2">
        ...
        <div id="state-p2c" className="state block-state flex-1 av-w-read py-6 practice-stage practice-stage--part2">
        ...
        <div id="state-feedback" className="state block-state flex-1 av-w-read py-8 ds-fadein practice-stage practice-stage--feedback">
        ...
        <div id="state-completion" className="state flex-1 items-center justify-center flex-col gap-0 px-6 text-center practice-stage practice-stage--completion">
        ...
        <div id="state-test-results" className="state block-state flex-1 av-w-read py-8 practice-stage practice-stage--summary">
