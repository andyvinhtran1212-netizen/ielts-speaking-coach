...
type Row = { id: string; slug: string; library: Exclude<Library, ''>; title: string; status: string; difficultyLevel: string | null; skillFocus: string | null; topicTags: string[]; examOnly: boolean; locked: boolean; shareActive: boolean; shareExpiresAt: string | null; contentAuditStatus: string | null; contentAuditedAt: string | null; updatedAt: string | null; createdAt: string | null };
