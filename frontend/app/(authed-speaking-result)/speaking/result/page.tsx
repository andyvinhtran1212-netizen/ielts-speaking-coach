...
const afterHydration = (fn) => {
  ...
  setTimeout(() => {
    ...
    console.error("[/pages/speaking-result.html] React khong hydrate sau 12s - sang ban legacy");
    window.location.replace("/pages/speaking-result.html" + window.location.search + window.location.hash);
  }, 12000);
};
