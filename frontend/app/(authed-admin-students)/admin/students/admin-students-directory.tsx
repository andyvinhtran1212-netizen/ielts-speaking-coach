...
function ProfileDialog({ profile, onClose }: { profile: ProfileState | null; onClose: () => void }) {
  ...
  return (
    <Dialog
      ...
      onClose={onClose}
      actions={<>
        {profile && <a className="adm-btn-secondary" href={`/pages/admin/writing/new.html?student_id=${encodeURIComponent(profile.id)}`}>Giao bài viết</a>}
