...
// Giữ markup parity nhưng mọi lối production vào picker đi qua route canonical.
const CANONICAL_BODY = BODY.replace('/pages/vocab-practice.html', '/vocabulary/practice');
...
export default function VocabularyHubPage() {
  return (
    <>
      ...
      <div dangerouslySetInnerHTML={{ __html: CANONICAL_BODY }} />
      {/* Duong lui chung mot nguon voi cac trang kia: lib/watchdog-script.ts */}
      <script dangerouslySetInnerHTML={{ __html: watchdogScript('/pages/vocabulary.html') }} />
