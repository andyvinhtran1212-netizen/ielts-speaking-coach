...
export function AdminListeningTests() {
  ...
  return <main className="alt-shell">
    <header className="alt-hero"><div><p className="alc-eyebrow">Listening · Test operations</p><h1>Kho test Listening</h1><p>Đối chiếu cấu trúc section, audio và phạm vi hiển thị trước khi phát hành hoặc dành riêng đề cho kỳ thi.</p></div><div className="alt-hero__actions"><a className="adm-btn-primary" href="/pages/admin/listening/import-fulltest.html">Import full test ↗</a><a className="adm-btn-secondary" href="/pages/admin/listening/import-drills.html">Import skill drill ↗</a></div></header>
