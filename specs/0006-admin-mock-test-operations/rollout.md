...
- Migrations 297–300 remain additive and compatible with currently deployed code.
...
- Dry-run and then apply migrations 297–300 with the advisory-locked repository runner.
...
- Dry-run and apply migrations 297–300 with `ALLOW_PROD=1` through the
