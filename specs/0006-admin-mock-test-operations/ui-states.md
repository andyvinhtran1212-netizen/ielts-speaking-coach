...
| Content bank | Bounded page loading does not clear known total | No matches names active filters and clear action | Only active page mounts; total/filter/readback are canonical | Preserve prior page, distinguish contract/load/save errors, retry explicitly | Existing admin gate remains authoritative | Table/cards avoid page overflow; row actions have contextual names; explicit save/cancel |
