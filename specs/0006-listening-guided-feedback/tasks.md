...
- [ ] Add typed reveal/state endpoints with no-unrevealed-key tests; regenerate
  frontend OpenAPI types.
- [ ] Connect the continuous and guided player UI to canonical save/reveal/
  resume state, including mixed objective/self-review feedback.
- [ ] Verify audio/replay/transcript restrictions and assisted result/history/
  analytics separation.
- [ ] Run affected full local suites and UI/accessibility/theme checks; review
