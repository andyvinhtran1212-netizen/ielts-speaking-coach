...
- **FR-005:** Pull requests declare a change class; feature and high-risk PRs
  reference an existing non-draft spec, while staging-to-main promotions remain
  exempt from duplicate feature metadata.
