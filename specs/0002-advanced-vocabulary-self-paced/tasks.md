...
- [ ] T003 Review migration 263, apply it to staging, and verify it creates only missing Advanced Vocabulary stores while idempotently extending existing course-section evidence. `depends: T002`
