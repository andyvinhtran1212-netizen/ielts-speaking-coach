...
- [ ] T004 Merge canonical backend assignment, persistence, learner, and admin result flows only after T003 schema verification, including pre-attempt Practice projection and deletion rejection for every partial-evidence store; include and pass the service/API, assignment-version, RLS, migration, replay/concurrency, and existing backend regression tests in this same tested SHA. `depends: T003`
- [ ] T005 Implement learner/admin UI states, independent Reading panes, and non-submittable Writing/Speaking reference surfaces; include and pass model, component/behavior, keyboard/focus, responsive, interruption/resume, and answer-boundary browser tests in this same tested SHA. `depends: T004`
