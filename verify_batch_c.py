...
articles_to_check = [
    ("foundations", "word-order"),
    ("ielts-grammar-lab", "overview-sentence-grammar"),
    ("ielts-grammar-lab", "percentages-and-proportions"),
    ("ielts-grammar-lab", "task2-introduction-grammar")
]
...
print("Batch C Verification Results:")
for r in results:
